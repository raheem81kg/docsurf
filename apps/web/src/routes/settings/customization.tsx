               ...
               <div className="space-y-6">
                  <div className="space-y-2">
                     ...
                     <Input
                        ...
                        maxLength={100}
                     />
                     <p className="text-muted-foreground text-xs">This helps the AI address you personally in conversations.</p>
                  </div>
                  ...
                  <div className="space-y-2">
                     ...
                     <Textarea
                        ...
                        maxLength={2000}
                     />
                     <p className="text-muted-foreground text-xs">Shape the AI's communication style and personality.</p>
                  </div>
