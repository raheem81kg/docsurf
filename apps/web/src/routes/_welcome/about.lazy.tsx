         ...
         <div className="m-auto my-20 max-w-[600px]">
            ...
            <div className="line-height-lg v-space-md text-component">
               ...
               <p className="mt-6 leading-7">
                  DocSurf is an AI-powered writing assistant platform that helps you create and edit documents with intelligent
                  support. We combine powerful writing tools with AI capabilities to enhance your writing experience, making it more
                  efficient and enjoyable.
               </p>

               <h2 className="mt-4 scroll-m-20 border-b pb-2 font-semibold text-xl tracking-tight first:mt-0">Why We Started</h2>
               <p className="mt-6 leading-7">
                  I started DocSurf because I recognized that writing needed a modern, intelligent approach. While there are many
                  writing tools available, none truly leverage AI to enhance the writing experience in real-time. I wanted to create a
                  platform that helps you write better through AI assistance, making the writing process more intuitive and efficient.
               </p>
               ...
               <p className="mt-6 leading-7">
                  Our users appreciate how DocSurf makes writing more efficient through AI assistance, whether they're working on
                  personal notes or professional documents. We're committed to continuously improving our AI capabilities to make
                  document creation even more powerful.
               </p>
