import {
	...
	AccordionItem,
	AccordionTrigger,
} from "@docsurf/ui/components/accordion";
		...
		<>
			<div className="container mx-auto">
				<div className="relative flex flex-col items-center text-center">
					<h1 className="mt-24 mb-4 text-center font-medium text-5xl">
					...
					<div className="mt-8 grid w-full max-w-5xl grid-cols-1 gap-10 md:grid-cols-2">
						{/* Starter Plan */}
						<div className="flex flex-col rounded-[4px] border bg-[#121212] p-8">
							<h2 className="mb-2 text-left text-xl">Starter</h2>
							<div className="mt-4 flex items-baseline">
								<span className="font-medium text-[40px] tracking-tight">
									$29
								</span>
							...
							<div className="mt-8">
								<h3 className="text-left font-medium font-mono text-[#878787] text-xs uppercase tracking-wide">
									INCLUDING
								</h3>
								<ul className="mt-4 space-y-2">
									...
									<li className="flex items-start">
										<Check className="mr-2 h-5 w-5 flex-shrink-0 text-primary" />
										<span className="text-sm">
											Smart text suggestions & completions
										</span>
									</li>
									<li className="flex items-start">
										<Check className="mr-2 h-5 w-5 flex-shrink-0 text-primary" />
										<span className="text-sm">
											Standard grammar & style checks
										</span>
									</li>
									<li className="flex items-start">
										<Check className="mr-2 h-5 w-5 flex-shrink-0 text-primary" />
							...
							<div className="mt-8 border-border border-t-[1px] pt-8">
								<Link to="/auth">
									<Button
										variant="outline"
										className="h-12 w-full border border-brand"
									>
										Start 14 day trial
									</Button>
								</Link>
						...
						{/* Pro Plan */}
						<div className="relative flex flex-col rounded-[4px] border border-brand bg-[#121212] p-8">
							<div className="absolute top-0 right-0 mt-4 mr-4 rounded-full border px-2 py-1 font-mono font-normal text-[#878787] text-[9px]">
								Limited offer
							</div>
							<h2 className="mb-2 text-left text-xl">Pro</h2>
							<div className="mt-1 flex items-baseline">
								<span className="font-medium text-[#878787] text-[40px] tracking-tight line-through">
									$99
								</span>
							...
							<div className="mt-8 border-border border-t pt-8">
								<Link to="/auth">
									<Button className="h-12 w-full">Start 14 day trial</Button>
								</Link>
							</div>
						</div>
					</div>
				...
				<div>
					...
					<Accordion type="single" collapsible className="mt-10 mb-48 w-full">
						<AccordionItem value="item-1">
							...
							<AccordionContent>
								Docsurf is an AI-powered document creation platform that helps
								you write better content faster. It offers intelligent
								suggestions, advanced editing tools, and seamless document
								management to unlock your writing potential.
							</AccordionContent>
						</AccordionItem>
						<AccordionItem value="item-2">
							...
							<AccordionContent>
								Our AI provides real-time suggestions, completions, and style
								enhancements as you type. It helps improve clarity, tone, and
								grammar, helping you craft high-quality documents more
								efficiently.
							</AccordionContent>
						</AccordionItem>
						<AccordionItem value="item-3">
							...
							<AccordionContent>
								Yes, you can easily import your existing `.docx` documents. Our
								platform preserves your original formatting, making the
								transition seamless so you can start enhancing them with AI
								right away.
							</AccordionContent>
						</AccordionItem>
						...
						<AccordionItem value="item-5">
							...
							<AccordionContent>
								...
								your subscription, you will still be able to use Docsurf until
