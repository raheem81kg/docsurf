			...
			<div className="m-auto my-20 max-w-[600px]">
				...
				<div className="line-height-lg v-space-md text-component">
					...
					<p className="mt-8 leading-7">
						DocSurf ("us", "we", or "our") operates the DocSurf application
					...
					<ul>
						<li>
							...
							<p className="mt-8 leading-7">
								Service is the DocSurf application operated by DocSurf
							</p>
						</li>
						<li>
							<p className="mt-8 leading-7">
					...
					<h2>Use of Data</h2>
					<p className="mt-8 leading-7">
						DocSurf uses the collected data for various purposes:
					</p>
					<ul>
					...
					<p className="mt-8 leading-7">
						DocSurf's use of information received from Google APIs will adhere
					...
					<p className="mt-8 leading-7">
						If you are from the European Economic Area (EEA), DocSurf's legal
					...
					<p className="mt-8 leading-7">
						DocSurf may process your Personal Data because:
					</p>
					<ul>
					...
					<p className="mt-8 leading-7">
						DocSurf will retain your Personal Data only for as long as is
					...
					<p className="mt-8 leading-7">
						DocSurf will also retain Usage Data for internal analysis purposes.
					...
					<p className="mt-8 leading-7">
						DocSurf will take all the steps reasonably necessary to ensure that
					...
					<p className="mt-8 leading-7">
						If DocSurf is involved in a merger, acquisition or asset sale, your
					...
					<p className="mt-8 leading-7">
						Under certain circumstances, DocSurf may be required to disclose
					...
					<p className="mt-8 leading-7">
						DocSurf may disclose your Personal Data in the good faith belief
					...
					<p className="mt-8 leading-7">
						...
						certain data protection rights. DocSurf aims to take reasonable
					...
					<ul>
						...
						<li>
							<p className="mt-8 leading-7">
								...
								the right to withdraw your consent at any time where DocSurf
