...
export const Route = createLazyFileRoute("/_welcome/policy")({
         ...
         <div className="line-height-lg v-space-md text-component">
            ...
            <ul>
               <li>
                  ...
                  <p className="mt-8 leading-7">Service is the DocSurf application operated by DocSurf</p>
               </li>
               <li>
                  <p className="mt-8 leading-7">
               ...
               <li>
                  ...
                  <p className="mt-8 leading-7">Cookies are small files stored on your device (computer or mobile device).</p>
               </li>
               <li>
                  <p className="mt-8 leading-7">
               ...
               <li>
                  ...
                  <p className="mt-8 leading-7">
                     Data Processor (or Service Provider) means any natural or legal person who processes the data on behalf of the
                     Data Controller.
                  </p>
                  <p className="mt-8 leading-7">
            ...
            <p className="mt-8 leading-7">
               When you access the Service with a mobile device, we may collect certain information automatically, including, but not
               limited to, the type of mobile device you use, your mobile device unique ID, the IP address of your mobile device, your
               mobile operating system, the type of mobile Internet browser you use, unique device identifiers and other diagnostic
               data ("Usage Data").
            </p>
            ...
            <h2>Use of Data</h2>
            <p className="mt-8 leading-7">DocSurf uses the collected data for various purposes:</p>
            <ul>
            ...
            <p className="mt-8 leading-7">
               DocSurf's use of information received from Google APIs will adhere to the Google API Services User Data Policy,
               including the Limited Use requirements.
            </p>
            <p className="mt-8 leading-7">
               We do not use any data obtained from Google Workspace APIs — including Gmail data — to develop, improve, or train
               generalized artificial intelligence (AI) or machine learning (ML) models.
            </p>
            <p className="mt-8 leading-7">
               User data accessed via Gmail scopes is used strictly for the purpose of reading and extracting relevant information from
               emails (such as invoices and receipts) to help users automate and manage their business finances. This data is never
               shared, sold, or used for advertising purposes.
            </p>
            ...
            <p className="mt-8 leading-7">
               If you are from the European Economic Area (EEA), DocSurf's legal basis for collecting and using the personal
               information described in this Privacy Policy depends on the Personal Data we collect and the specific context in which
               we collect it.
            </p>
            <p className="mt-8 leading-7">DocSurf may process your Personal Data because:</p>
            <ul>
            ...
            <p className="mt-8 leading-7">
               DocSurf will retain your Personal Data only for as long as is necessary for the purposes set out in this Privacy Policy.
            ...
            <p className="mt-8 leading-7">
               DocSurf will also retain Usage Data for internal analysis purposes. Usage Data is generally retained for a shorter
            ...
            <p className="mt-8 leading-7">
               DocSurf will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with
            ...
            <p className="mt-8 leading-7">
               If DocSurf is involved in a merger, acquisition or asset sale, your Personal Data may be transferred. We will provide
               notice before your Personal Data is transferred and becomes subject to a different Privacy Policy.
            </p>
            <br />
            <h3>Disclosure for Law Enforcement</h3>
            <p className="mt-8 leading-7">
               Under certain circumstances, DocSurf may be required to disclose your Personal Data if required to do so by law or in
               response to valid requests by public authorities (e.g. a court or a government agency).
            </p>
            <br />
            <h3>Legal Requirements</h3>
            <p className="mt-8 leading-7">
               DocSurf may disclose your Personal Data in the good faith belief that such action is necessary to:
            </p>
            <ul>
               <li>To comply with a legal obligation</li>
               <li>To protect and defend the rights or property of DocSurf</li>
            ...
            <p className="mt-8 leading-7">
               If you are a resident of the European Economic Area (EEA), you have certain data protection rights. DocSurf aims to take
               reasonable steps to allow you to correct, amend, delete or limit the use of your Personal Data.
            </p>
            <p className="mt-8 leading-7">
               If you wish to be informed about what Personal Data we hold about you and if you want it to be removed from our systems,
               please contact us.
            </p>
            <p className="mt-8 leading-7">In certain circumstances, you have the following data protection rights:</p>
            <ul>
               <li>
                  <p className="mt-8 leading-7">
               ...
               <li>
                  <p className="mt-8 leading-7">
                     ...
                     DocSurf relied on your consent to process your personal information.
                  </p>
               </li>
            </ul>
            <p className="mt-8 leading-7">
            ...
            <br />
            <h3>Analytics</h3>
            <p className="mt-8 leading-7">We may use third-party Service Providers to monitor and analyse the use of our Service.</p>
            <ul>
               <li>
                  <p className="mt-8 leading-7">
            ...
            <p className="mt-8 leading-7">The payment processors we work with are:</p>
            <ul>
               <li>
                  <p className="mt-8 leading-7">
            ...
            <p className="mt-8 leading-7">Our Service does not address anyone under the age of 18 ("Children").</p>
            <p className="mt-8 leading-7">
