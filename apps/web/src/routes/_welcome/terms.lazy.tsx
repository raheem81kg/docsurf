...
export const Route = createLazyFileRoute("/_welcome/terms")({
      ...
      <div className="m-auto my-20 max-w-[600px]">
         ...
         <div className="line-height-lg v-space-md text-component">
            ...
            <p className="mt-8 leading-7">
               ...
               "Service") operated by DocSurf ("us", "we", or "our").
            </p>

            <p className="mt-8 leading-7">
               Please read these Terms and Conditions carefully before using our DocSurf application (the "Service").
            </p>
            ...
            <p className="mt-8 leading-7">
               ...
               cancel it or DocSurf cancels it. You may cancel your Subscription renewal either through your online account management
               page or by contacting DocSurf customer support team.
            </p>

            <p className="mt-8 leading-7">
               A valid payment method, including credit card, is required to process the payment for your Subscription. You shall
               provide DocSurf with accurate and complete billing information including full name, address, state, zip code, telephone
               number, and a valid payment method information. By submitting such payment information, you automatically authorize
               DocSurf to charge all Subscription fees incurred through your account to any such payment instruments.
            </p>

            <p className="mt-8 leading-7">
               Should automatic billing fail to occur for any reason, DocSurf will issue an electronic invoice indicating that you must
               proceed manually, within a certain deadline date, with the full payment corresponding to the billing period as indicated
               on the invoice.
            </p>
            ...
            <p className="mt-8 leading-7">
               DocSurf, in its sole discretion and at any time, may modify the Subscription fees for the Subscriptions. Any
               Subscription fee change will become effective at the end of the then-current Billing Cycle.
            </p>

            <p className="mt-8 leading-7">
               DocSurf will provide you with a reasonable prior notice of any change in Subscription fees to give you an opportunity to
               terminate your Subscription before such change becomes effective.
            </p>

            <p className="mt-8 leading-7">
               Your continued use of the Service after the Subscription fee change comes into effect constitutes your agreement to pay
            ...
            <p className="mt-8 leading-7">
               Certain refund requests for Subscriptions may be considered by DocSurf on a case-by-case basis and granted in sole
               discretion of DocSurf.
            </p>
            ...
            <p className="mt-8 leading-7">
               ...
               videos, or other material ("Content"). You are responsible for the Content that you post to the Service, including its
            ...
            <p className="mt-8 leading-7">
               ...
               the Service infringes the copyright or other intellectual property infringement ("Infringement") of any person.
            </p>
            ...
            <p className="mt-8 leading-7">
               ...
               remain the exclusive property of DocSurf and its licensors. The Service is protected by copyright, trademark, and other
               laws of both the United States and foreign countries. Our trademarks and trade dress may not be used in connection with
               any product or service without the prior written consent of DocSurf.
            </p>

            <h2>Links To Other Web Sites</h2>

            <p className="mt-8 leading-7">
               Our Service may contain links to third-party web sites or services that are not owned or controlled by DocSurf.
            </p>

            <p className="mt-8 leading-7">
               DocSurf has no control over, and assumes no responsibility for, the content, privacy policies, or practices of any third
               party web sites or services. You further acknowledge and agree that DocSurf shall not be responsible or liable, directly
            ...
            <p className="mt-8 leading-7">
               In no event shall DocSurf, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any
               ...
               (including negligence) or any other legal theory, whether or not we have been informed of the possibility of such
            ...
            <p className="mt-8 leading-7">
               ...
               Service is provided without warranties of any kind, whether express or implied, including, but not limited to, implied
               warranties of merchantability, fitness for a particular purpose, non-infringement or course of performance.
            </p>

            <p className="mt-8 leading-7">
               DocSurf its subsidiaries, affiliates, and its licensors do not warrant that a) the Service will function uninterrupted,
               secure or available at any particular time or location; b) any errors or defects will be corrected; c) the Service is
               free of viruses or other harmful components; or d) the results of using the Service will meet your requirements.
            </p>
