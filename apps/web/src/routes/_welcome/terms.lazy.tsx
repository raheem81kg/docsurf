			...
			<div className="m-auto my-20 max-w-[600px]">
				...
				<div className="line-height-lg v-space-md text-component">
					...
					<p className="mt-8 leading-7">
						...
						your relationship with DocSurf application (the "Service") operated
						by DocSurf ("us", "we", or "our").
					</p>

					<p className="mt-8 leading-7">
						Please read these Terms and Conditions carefully before using our
						DocSurf application (the "Service").
					</p>
					...
					<p className="mt-8 leading-7">
						...
						cancel it or DocSurf cancels it. You may cancel your Subscription
						renewal either through your online account management page or by
						contacting DocSurf customer support team.
					</p>

					<p className="mt-8 leading-7">
						A valid payment method, including credit card, is required to
						process the payment for your Subscription. You shall provide DocSurf
						...
						automatically authorize DocSurf to charge all Subscription fees
						incurred through your account to any such payment instruments.
					</p>

					<p className="mt-8 leading-7">
						Should automatic billing fail to occur for any reason, DocSurf will
					...
					<p className="mt-8 leading-7">
						DocSurf, in its sole discretion and at any time, may modify the
					...
					<p className="mt-8 leading-7">
						DocSurf will provide you with a reasonable prior notice of any
					...
					<p className="mt-8 leading-7">
						...
						DocSurf on a case-by-case basis and granted in sole discretion of
						DocSurf.
					</p>
					...
					<p className="mt-8 leading-7">
						...
						"Copyright Infringement" of support@docsurf.com and include in your
					...
					<p className="mt-8 leading-7">
						...
						property of DocSurf and its licensors. The Service is protected by
					...
					<p className="mt-8 leading-7">
						...
						that are not owned or controlled by DocSurf.
					</p>

					<p className="mt-8 leading-7">
						DocSurf has no control over, and assumes no responsibility for, the
						content, privacy policies, or practices of any third party web sites
						or services. You further acknowledge and agree that DocSurf shall
					...
					<p className="mt-8 leading-7">
						In no event shall DocSurf, nor its directors, employees, partners,
					...
					<p className="mt-8 leading-7">
						DocSurf its subsidiaries, affiliates, and its licensors do not
