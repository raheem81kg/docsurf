...
export const SectionSix: React.FC<SectionSixProps> = ({
   ...
   return (
      <div className="flex w-full items-center justify-between gap-2 px-2">
         ...
         <span className={`text-xs ${isLimit ? "font-bold text-red-600" : "text-muted-foreground"}`}>{remaining}</span>
         {/* Center: Dynamic word/char count */}
         <span className="select-none hidden lg:block text-center text-xs text-muted-foreground">
            {used} | {words} words
         </span>
