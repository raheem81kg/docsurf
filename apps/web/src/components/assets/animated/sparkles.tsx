...
const SparklesIcon = forwardRef<SparklesIconHandle, HTMLAttributes<HTMLDivElement> & { size?: number; svgClassName?: string }>(
   ({ onMouseEnter, onMouseLeave, size = 17, svgClassName, ...props }, ref) => {
