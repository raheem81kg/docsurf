                  ...
                  <div className="flex items-start justify-between">
                     <div className="flex items-start gap-3">
                        ...
                        <div>
                           ...
                           <p className="mt-0.5 text-muted-foreground text-xs">Access GPT-4, GPT-4o, o3, and other OpenAI models</p>
                        </div>
                     </div>
                  </div>
               </Card>
      ...
      content: (
         <div className="space-y-6">
            ...
            <div className="space-y-3">
               ...
               <p className="text-muted-foreground text-sm leading-relaxed">
                  Access up-to-date information from the web. Choose from multiple search providers and get comprehensive answers
         ...
         <div className="space-y-6">
            <div className="flex flex-wrap gap-1.5">
               {[
                  ...
                  <div key={label} className="flex items-center space-x-2 rounded-lg border border-border/50 bg-muted/10 px-3 py-2">
      ...
      <div className="w-full max-w-md space-y-4">
         <div className="space-y-3">
            <div className="flex items-center justify-between">
               ...
               <Button variant="outline" size="sm" onClick={toggleMode} className="flex h-8 items-center justify-center gap-2 px-3">
                  ...
                  <span className="text-xs">{themeState.currentMode === "light" ? "Light" : "Dark"}</span>
               </Button>
            </div>
                  ...
                  return (
                     ...
                     >
                        <div className="mb-1 flex items-center justify-between">
                           ...
                           {isSelected && <CheckCircle className="h-3 w-3 flex-shrink-0 text-primary" />}
                        </div>
                        {colors.length > 0 && (
            ...
            >
               <Card className="inset-shadow-sm w-full max-w-none overflow-hidden border-2 bg-card pt-3 pb-5">
                     ...
                     <AnimatePresence mode="wait">
                        ...
                        >
                           <CardContent className="flex flex-col items-center px-4 py-4 sm:px-6">
                              <div className="flex w-full max-w-lg justify-center">{currentStepData.content}</div>
                           </CardContent>
                        </motion.div>
                     </AnimatePresence>
                  </div>
                  ...
                  <CardFooter className="relative flex items-center justify-between border-t-2 px-4 pt-4 sm:px-6">
                     ...
                     <Button onClick={handleNext} className="h-8 gap-2 px-3 text-xs sm:h-10 sm:px-4 sm:text-sm">
