...
export function HeroImage() {
   ...
   return (
      <div className="-right-[420px] -top-[100px] 2xl:-top-[20px] z-10 mt-10 scale-100 sm:scale-100 md:mt-0 md:scale-[0.9] lg:absolute lg:scale-[0.7] xl:scale-100 2xl:scale-[1.35]">
         <motion.div
         ...
         >
            <div className="[transform:perspective(4101px)_rotateX(51deg)_rotateY(-13deg)_rotateZ(40deg)]">
               <DynamicImage
                  ...
                  alt="DocSurf modern document editor dashboard with AI writing assistant, chat interface, and document management features"
                  width={1141}
                  height={641}
