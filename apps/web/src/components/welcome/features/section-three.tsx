						...
						<div className="flex flex-col space-y-2">
							<div className="mt-8 flex items-center space-x-2 text-sm">
								...
								<span className="text-primary">
									Smart text suggestions as you type
								</span>
							</div>
							<div className="flex items-center space-x-2 text-sm">
								...
								<span className="text-primary">
									One-click text improvements & rewrites
								</span>
							</div>
							...
							<div className="demo-suggestion-overlay-animated min-w-[38ch] border border-border bg-default px-3 py-2.5">
								...
								<div className="demo-overlay-actions mt-2">
									<Button
										variant="ghost"
										size="sm"
										className="!py-0.5 h-7 rounded-full px-2 text-xs hover:text-destructive"
									>
									...
									<Button
										variant="ghost"
										size="sm"
										className="!py-0.5 h-7 rounded-full px-2 text-xs hover:text-primary"
									>
