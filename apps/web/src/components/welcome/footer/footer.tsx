				...
				<div className="flex w-full flex-col md:flex-row">
					...
					<div className="mt-8 flex md:mt-0 md:w-6/12 md:justify-end">
						<div className="flex flex-col md:items-end">
							...
							{/* <div className="md:mr-0 mt-auto mr-auto"><StatusWidget /></div> */}
						</div>
					</div>
				</div>
			</div>

			<h5 className="pointer-events-none text-center text-[#F4F4F3] text-[500px] leading-none dark:text-[#161616]">
				docsurf
			</h5>
		</footer>
	);
