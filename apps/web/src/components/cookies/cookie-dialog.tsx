...
import { useCookies } from "@/components/providers/cookie-provider";
						...
						<DialogHeader>
							...
							<DialogDescription className="space-y-4">
								<span className="block text-sm text-zinc-600 dark:text-zinc-400">
									...
									"Customize" or reject all optional cookies by clicking "Reject
									All".
								</span>
								<span className="block text-sm text-zinc-600 dark:text-zinc-400">
									For California residents (CCPA): We do not sell your personal
									information. However, some cookies collect data for targeted
									advertising. To opt out of the sale of your data for targeted
									advertising purposes, click "Reject All" or disable Marketing
									cookies below.
								</span>
								<span className="block text-sm text-zinc-600 dark:text-zinc-400">
			...
			{showBanner && (
				<Card className="fade-in slide-in-from-bottom-4 fixed right-4 bottom-4 left-4 z-40 animate-in border-zinc-200 bg-white p-4 shadow-lg duration-300 md:right-4 md:left-auto md:max-w-md dark:border-zinc-800 dark:bg-black">
					...
					<p className="mb-4 text-sm text-zinc-600 dark:text-zinc-400">
						...
						this site you agree to our use of cookies. For California residents:
						We do not sell personal information, but some cookies enable
