...
import { useCookies } from "@/components/providers/compliant-cookie-provider";
import { COOKIE_CATEGORIES, type CookieCategory } from "@/lib/cookies/cookies";
...
export function CookieConsent({ children, showFloatingButton = true }: CookieConsentProps) {
   ...
   return (
      <>
         ...
         <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="flex max-h-[90vh] flex-col gap-0 border-zinc-200 bg-white p-0 outline-none dark:border-zinc-800 dark:bg-black">
               <div className="border-zinc-200 px-6 py-6 dark:border-zinc-800">
                  <DialogHeader>
                     <DialogTitle className="my-2 text-xl text-zinc-900 dark:text-zinc-100">Cookie Settings</DialogTitle>
                     <DialogDescription className="space-y-4">
                        <span className="block text-sm text-zinc-600 dark:text-zinc-400">
                           ...
                           better experience. By clicking "Accept All", you consent to all cookies. You can customize your choices by
                           clicking "Customize" or reject all optional cookies by clicking "Reject All".
                        </span>
                        <span className="block text-sm text-zinc-600 dark:text-zinc-400">
                           For California residents (CCPA): We do not sell your personal information. However, some cookies collect
                           data for targeted advertising. To opt out of the sale of your data for targeted advertising purposes, click
                           "Reject All" or disable Marketing cookies below.
                        </span>
                        <span className="block text-sm text-zinc-600 dark:text-zinc-400">
                              ...
                              >
                                 ...
                                 <AccordionContent className="pt-2 pb-4">
                                    <div className="space-y-3">
                                       ...
                                       <div>
                                          <p className="font-medium text-sm text-zinc-700 dark:text-zinc-300">Duration:</p>
                                       ...
                                       <div>
                                          <p className="font-medium text-sm text-zinc-700 dark:text-zinc-300">Provider:</p>
                                          <p className="text-sm text-zinc-600 dark:text-zinc-400">
                                             {category === "necessary"
               ...
               <div className="border-zinc-200 border-t bg-white px-6 py-4 dark:border-zinc-800 dark:bg-black">
         ...
         {showBanner && (
            <Card className="fade-in slide-in-from-bottom-4 fixed right-4 bottom-4 left-4 z-40 animate-in border-zinc-200 bg-white p-4 shadow-lg duration-300 md:right-4 md:left-auto md:max-w-md dark:border-zinc-800 dark:bg-black">
               ...
               <p className="mb-4 text-sm text-zinc-600 dark:text-zinc-400">
                  We use cookies to enhance your experience. By continuing to visit this site you agree to our use of cookies. For
                  California residents: We do not sell personal information, but some cookies enable targeted advertising.
               </p>
