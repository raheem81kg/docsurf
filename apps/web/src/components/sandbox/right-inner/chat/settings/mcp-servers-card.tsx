...
import type { MCPServerConfig, UserSettings } from "@docsurf/backend/convex/schema/settings";
...
export const MCPServersCard = memo(({ userSettings, onSave, loading }: MCPServersCardProps) => {
   ...
   const handleSaveServer = async (serverIndex: number, updatedServer: Infer<typeof MCPServerConfig>) => {
         ...
         {addingNewServer ? (
            <Card className="p-4 shadow-xs">
               <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                     ...
                     <div className="flex gap-2">
                        <Button onClick={handleAddNewServer} disabled={loading || !newServer.name || !newServer.url} size="sm">
            ...
            <Card className="border-dashed p-4 shadow-xs">
               <div className="flex flex-col items-center justify-center py-6 text-center">
                  ...
                  <Button variant="outline" size="sm" onClick={() => setAddingNewServer(true)}>
                     <Plus className="h-4 w-4" />
                     Add Server
                  </Button>
               </div>
