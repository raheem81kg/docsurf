...
export const MCPServerCard = memo(({ server, serverIndex, onSave, onDelete, loading }: MCPServerCardProps) => {
            ...
            <div className="flex-1">
               <div className="mb-4 flex items-start justify-between">
                  ...
                  <div className="flex items-center gap-2">
                     <div className={cn("h-2 w-2 rounded-full", isEnabled ? "bg-green-500" : "bg-gray-400")} />
                     <span className="text-muted-foreground text-xs">{isEnabled ? "Active" : "Disabled"}</span>
                  </div>
               </div>
               ...
               {isEditing ? (
                  <div className="space-y-4">
                     <div className="flex items-center space-x-2">
                        ...
                        />
                        <Label htmlFor={`mcp-enabled-${serverIndex}`}>Enable {server.name}</Label>
                     </div>

                     <div className="space-y-3">
                        <div>
                           <Label htmlFor={`mcp-name-${serverIndex}`} className="text-xs">
                              Server Name
                           </Label>
                           <Input
                        ...
                        <div>
                           <Label htmlFor={`mcp-url-${serverIndex}`} className="text-xs">
                              Server URL
                           </Label>
                           <Input
                        ...
                        <div>
                           <Label htmlFor={`mcp-type-${serverIndex}`} className="text-xs">
                              Transport Type
                           </Label>
                           <div className="mt-1 flex gap-2">
                              ...
                              <Button
                                 variant={formData.type === "sse" ? "default" : "outline"}
                                 size="sm"
                        ...
                        {showAddHeader ? (
                           <div className="space-y-2">
                              ...
                              <div className="flex gap-2">
                                 ...
                                 <Input
                                    ...
                                    className="flex-1"
                                 />
                                 <Button size="sm" onClick={handleAddHeader} disabled={!newHeader.key || !newHeader.value}>
                                    Add
                                 </Button>
                                 <Button
                                    variant="ghost"
                           ...
                           <Button variant="outline" size="sm" onClick={() => setShowAddHeader(true)}>
                     ...
                     <div className="flex gap-2">
                        <Button onClick={handleSave} disabled={loading || !formData.name || !formData.url} size="sm">
                     ...
                     <AlertDialog>
                        ...
                        <AlertDialogContent>
                           <AlertDialogHeader>
                              ...
                              <AlertDialogDescription>
                                 Are you sure you want to delete "{server.name}"? This action cannot be undone and will remove access
