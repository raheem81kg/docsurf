...
export const SearchProviderCard = memo(({ provider, isSelected, onSelect, title, description }: SearchProviderCardProps) => {
         ...
         <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
               <div className="flex items-center gap-2">
                  <Label className="cursor-pointer font-medium text-foreground">{title}</Label>
...
type BYOKSearchProviderCardProps = {
   ...
   onSave: (providerId: string, config: { enabled: boolean; newKey?: string } & Record<string, any>) => Promise<void>;
   loading: boolean;
};

export const BYOKSearchProviderCard = memo(({ provider, currentConfig, onSave, loading }: BYOKSearchProviderCardProps) => {
      ...
      <Card className="p-4 shadow-xs">
         <div className="flex items-start gap-2 space-y-4">
            <div className="flex size-8 items-center justify-center rounded-lg">
               {typeof Icon === "string" ? <span className="text-2xl">{Icon}</span> : <Icon className="size-5" />}
            </div>
            <div className="flex-1">
               ...
               {isEditing ? (
                  <div className="space-y-4">
                     <div className="flex items-center space-x-2">
                        ...
                        <Label htmlFor={`${provider.id}-enabled`}>Enable {provider.name} BYOK</Label>
                     </div>
                     ...
                     {enabled && (
                        <div className="space-y-3">
                           ...
                           {provider.id === "brave" && (
                              <div className="space-y-4">
                                 <div className="grid grid-cols-2 gap-4">
                                    <div className="space-y-2">
                                       <Label htmlFor={`${provider.id}-country`}>Country</Label>
                                       <Select
                                    ...
                                    <div className="space-y-2">
                                       <Label htmlFor={`${provider.id}-lang`}>Search Language</Label>
                                       <Select
                                 ...
                                 <div className="space-y-2">
                                    <Label htmlFor={`${provider.id}-safesearch`}>Safe Search</Label>
                                    <Select
                                    ...
                                    >
                                       ...
                                       <SelectContent>
                                          {BRAVE_SAFESEARCH_OPTIONS.map((option) => (
                           ...
                           {provider.id === "serper" && (
                              <div className="grid grid-cols-2 gap-4">
                                 <div className="space-y-2">
                                    <Label htmlFor={`${provider.id}-language`}>Language</Label>
                                    <Select
                                 ...
                                 <div className="space-y-2">
                                    <Label htmlFor={`${provider.id}-country-serper`}>Country</Label>
                                    <Select
                                       value={additionalFields.country}
                                       onValueChange={(value) =>
                                          setAdditionalFields((prev) => ({
                           ...
                           {enabled && !hasExistingKey && !newKey.trim() && (
                              <div className="flex items-center gap-2 text-amber-600">
                                 ...
                                 <span className="text-sm">API key required to enable BYOK</span>
                              </div>
                           )}
                        </div>
                     )}
                  ...
                  <Button variant="outline" size="sm" onClick={() => setIsEditing(true)}>
                     {isEnabled ? <SquarePen className="size-4" /> : <Key className="size-4" />}
