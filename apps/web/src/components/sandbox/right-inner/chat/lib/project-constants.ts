...
export function getProjectColorClasses(colorId: ProjectColorId | undefined): string {
   if (!colorId) return "text-gray-500 bg-gray-500 border-gray-400 dark:text-gray-600 dark:bg-gray-600 dark:border-gray-500";

   const color = PROJECT_COLORS.find((c) => c.id === colorId);
   return color?.class || "text-gray-500 bg-gray-500 border-gray-400 dark:text-gray-600 dark:bg-gray-600 dark:border-gray-500";
}
