...
import { CheckCircle, LoaderIcon, MoonIcon, PaintBucketIcon, PlusIcon, Search, ShuffleIcon, SunIcon } from "lucide-react";
   ...
   return (
      <>
         ...
         <div className="flex items-center gap-2">
            <Button variant="outline" size="icon" className="size-8 rounded-md" onClick={toggleMode}>
            ...
            <ResponsivePopover modal={false}>
               <ResponsivePopoverTrigger asChild>
                  <Button variant="outline" size="icon" className="flex size-8 items-center rounded-md">
