   ...
   return {
         ...
         parameters: z.object({
            ...
            metadata: z
               .object({
                  ...
                  category: z.union([z.string().describe("Category to organize this memory. Optional."), z.null()]),
                  tags: z.union([z.array(z.string()).describe("Tags to help find this memory later. Optional."), z.null()]),
               })
      ...
      search_memories: tool({
         ...
         parameters: z.object({
            ...
            limit: z.number().min(1).max(10).default(5).describe("Maximum number of memories to return. Default is 5."),
