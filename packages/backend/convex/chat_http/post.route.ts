...
import type { ReasoningEffort } from "@docsurf/web/src/store/model-store";
         ...
         if (model.modelType === "image") {
            ...
            if (typeof prompt !== "string" || !prompt.trim()) {
               ...
               parts.push({
                  ...
                  error: {
                     code: "unknown",
                     message: "No prompt provided for image generation. Please provide a description of the image you want to create.",
                  },
               });
               dataStream.write(
